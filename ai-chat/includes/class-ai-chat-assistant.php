...
class AI_Chat_Assistant {
    ...
    private function load_dependencies() {
        ...
        require_once plugin_dir_path(__FILE__) . 'class-ai-integration.php';
        require_once plugin_dir_path(__FILE__) . 'class-chat-room.php';
        require_once plugin_dir_path(__FILE__) . 'class-user-chat.php';
        
        // Admin class
        require_once plugin_dir_path(__DIR__) . 'admin/class-admin.php';
        
        // Public class
        require_once plugin_dir_path(__DIR__) . 'public/class-public.php';
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_ai_chat_manage_room', $plugin_admin, 'manage_chat_room');
    }
    ...
    private function define_public_hooks() {
        ...
        // Additional ajax handlers for user-to-user chat
        $this->loader->add_action('wp_ajax_user_chat_mark_read', $plugin_public, 'handle_user_chat_mark_read');
        $this->loader->add_action('wp_ajax_user_chat_get_messages', $plugin_public, 'handle_user_chat_get_messages');
        $this->loader->add_action('wp_ajax_user_chat_get_new_messages', $plugin_public, 'handle_user_chat_get_new_messages');
        $this->loader->add_action('wp_ajax_user_chat_get_users', $plugin_public, 'handle_user_chat_get_users');
        $this->loader->add_action('wp_ajax_user_chat_get_user_info', $plugin_public, 'handle_user_chat_get_user_info');
        
        // Additional ajax handlers for group chat
        $this->loader->add_action('wp_ajax_group_chat_get_messages', $plugin_public, 'handle_group_chat_get_messages');
        $this->loader->add_action('wp_ajax_group_chat_get_new_messages', $plugin_public, 'handle_group_chat_get_new_messages');
        $this->loader->add_action('wp_ajax_group_chat_create_room', $plugin_public, 'handle_group_chat_create_room');
    }
